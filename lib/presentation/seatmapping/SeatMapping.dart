...
import 'package:tentwentyflutterasgn/presentation/Theme/app_decoration.dart';
import 'package:tentwentyflutterasgn/presentation/Theme/custom_button_style.dart';
...
import 'package:tentwentyflutterasgn/presentation/seatmapping/HallSeatingPlan.dart';
import 'package:tentwentyflutterasgn/widgets/CustomColors.dart';
import 'package:tentwentyflutterasgn/widgets/app_bar/appbar_subtitle.dart';
import 'package:tentwentyflutterasgn/widgets/app_bar/appbar_subtitle_two.dart';
import 'package:tentwentyflutterasgn/widgets/app_bar/custom_app_bar.dart';
import 'package:tentwentyflutterasgn/widgets/custom_elevated_button.dart';
import 'package:tentwentyflutterasgn/widgets/custom_image_view.dart';
import 'package:tentwentyflutterasgn/widgets/fortytwo_item_widget.dart';

// ignore: must_be_immutable
class SeatMapping extends StatelessWidget {
  const SeatMapping({Key? key})
      : super(
          key: key,
        );
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return CustomAppBar(
        ...
        title: Column(children: [
          ...
          SizedBox(height: 1.v),
          AppbarSubtitleTwo(text: "In theaters december 22, 2021")
        ]),
        ...
        child: IntrinsicWidth(
            child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              Wrap(
                  ...
                  spacing: 12.h,
                  children:
                  List<Widget>.generate(10, (index) => FortytwoItemWidget())),
  ...
  onTapSelectSeats(BuildContext context) {
    ...
    Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => HallSeatingPlan(),
        ));
  }
}
